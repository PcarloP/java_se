	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
	   ...
	   // request.getServletContext().getRequestDispatcher("/jsp/header.jsp").include(request, response);
	    ...
	    if (pagina == null || pagina.trim().isEmpty()) {
	        // Nessun parametro "pagina" -> mostro home.jsp
	    ...
	    switch (pagina) {
	        ...
	        case "3": // Ricerca per nome
	    		...
	    		try {
	    	        ...
	    	        RequestDispatcher dispatcher = request.getRequestDispatcher("/jsp/findbyname.jsp");
	        ...
	        default:
	            // Qualsiasi altra pagina sconosciuta → vai su home
	            request.getRequestDispatcher("/jsp/home.jsp").forward(request, response);
	            break;
	    }

	    // Includi eventualmente il footer
