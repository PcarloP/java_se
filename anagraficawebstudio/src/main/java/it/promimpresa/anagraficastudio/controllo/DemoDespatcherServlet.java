...
/**
 * Servlet implementation class DemoDespatcherServlet
 */
@WebServlet("/demodespatcher")
public class DemoDespatcherServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DemoDespatcherServlet() {
		super();
